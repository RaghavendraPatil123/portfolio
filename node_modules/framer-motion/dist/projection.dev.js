    ...
    function updateMotionValuesFromProps(element, next, prev) {
        ...
        for (const key in next) {
            ...
            if (isMotionValue(nextValue)) {
                 ...
                 */
                {
                    warnOnce(nextValue.version === "11.0.16", `Attempting to mix Framer Motion versions ${nextValue.version} with 11.0.16 may not work as expected.`);
                }
            }
